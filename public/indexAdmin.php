...
<td><form method='post' action='../manageAdmins/itemsManager.php'><input type = hidden name = 'id' value='%d'><input type = 'hidden' name = 'action' value='delete'><Input class='link-lookalike' id='link' type='submit' value='Delete' name='Delete' onClick='return confirmSubmit2()'></form></td>
